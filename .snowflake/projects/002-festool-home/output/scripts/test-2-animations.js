/* test-2 animations engine: image-slot.js (vendored) + page behavior. */
...
/* =====================================================================
   test-2 page behavior (extracted from source inline <script>).
   React/Babel "tweaks panel" was a dev-only design tool — stripped.
   Runs in the delayed phase; header lives in a fetched fragment, so
   null-guarded. .reveal elements get .in on scroll, with a 500ms
   fallback that reveals everything (matches source behavior).
   ===================================================================== */
(function () {
