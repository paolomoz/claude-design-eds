...
/* test-4 behavior (extracted from source inline <script>): reward-seats toggle.
   Null-guarded; runs in delayed phase after the search-band is in the DOM. */
(function () {
  var t = document.getElementById('rewardToggle');
