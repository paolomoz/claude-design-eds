...
(function(){var h=document.getElementById('siteHeader');if(h)addEventListener('scroll',function(){h.classList.toggle('scrolled',scrollY>8)},{passive:true});
var m=document.getElementById('mnav'),o=document.getElementById('menuOpen'),c=document.getElementById('menuClose');
if(m&&o&&c){o.onclick=function(){m.classList.add('open')};c.onclick=function(){m.classList.remove('open')};m.onclick=function(e){if(e.target===m)m.classList.remove('open')};m.querySelectorAll('a.ml').forEach(function(a){a.onclick=function(){m.classList.remove('open')}});}
document.querySelectorAll('.filters .chip').forEach(function(x){x.onclick=function(){var a=document.querySelector('.filters .chip.active');if(a)a.classList.remove('active');x.classList.add('active')}});})();
