...
/**
 * tools/da/build-harness.mjs — build a local QA harness from a DA content page.
 *
 ...
 *
 * Usage: node tools/da/build-harness.mjs <contentFile> <outHarness>
 *   e.g. node tools/da/build-harness.mjs content/snowflake-blocks/test-12.html qa/test-12.html
 *
...
if (!inFile || !outFile) {
  process.stderr.write('usage: node tools/da/build-harness.mjs <contentFile> <outHarness>\n');
  process.exit(1);
}
