/* =====================================================================
   test-1 animations / behavior engine.
   Part 1: image-slot.js (vendored verbatim from source) — defines the
           <image-slot> custom element. Renders placeholders read-only
           outside its omelette runtime; the .image-slots.state.json
           fetch 404s harmlessly.
   Part 2: page behavior (scroll shadow, mobile menu, filter chips).
   ===================================================================== */

/* ───────────────────────── Part 1: image-slot.js ───────────────────────── */
...
/* ───────────────────────── Part 2: page behavior ───────────────────────── */

/* =====================================================================
   test-1 page behavior (extracted from source inline <script>).
   Runs in the delayed phase, after header/footer fragments are injected.
   Null-guarded because the referenced elements live in fetched fragments.
   The source's used-equipment card builder was intentionally dropped —
   the 6 cards are pre-rendered in the template so each field is authorable.
   ===================================================================== */
(function () {
  ...
  document.querySelectorAll('.filters .chip').forEach((c) => {
    c.onclick = () => {
      document.querySelector('.filters .chip.active')?.classList.remove('active');
