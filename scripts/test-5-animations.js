/* test-5 animations: image-slot.js (vendored). Meridian is a React SPA; its interactivity (search form, traveller stepper, cabin tabs) is not ported — the rendered design is frozen to a static, authorable overlay. */
